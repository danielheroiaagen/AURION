...
Definir operación diaria de AURION.
...
- Monitorizar salud de servicios.
- Revisar llamadas fallidas.
- Verificar colas y latencia.
...
- Toda tarea repetible debe convertirse en runbook.
- Toda métrica crítica debe tener alerta.
