...
## Objetivo
Este documento define límites y estructura técnica del repositorio principal.

## Alcance
Este documento pertenece a **42_MONOREPO** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.
