---
project: AURION
document: Pricing Finance Model
folder: 35_LEGAL_FINANCE
...
# Pricing Finance Model

## Objetivo
Este documento reduce riesgo legal y financiero al definir políticas, contratos, costes y preparación regulatoria.

## Alcance
Este documento pertenece a **35_LEGAL_FINANCE** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.

## Decisiones no negociables
- Trabajar con precisión, trazabilidad y documentación.
- Mantener coherencia con la visión de AURION.
- No introducir decisiones importantes sin ADR o documento asociado.
- Toda entrega debe ser verificable.
