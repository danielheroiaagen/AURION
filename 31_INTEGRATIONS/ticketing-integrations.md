---
project: AURION
document: Ticketing Integrations
folder: 31_INTEGRATIONS
...
## Objetivo
Este documento define cómo AURION se conecta a sistemas externos sin romper seguridad, trazabilidad ni mantenibilidad.

## Alcance
Este documento pertenece a **31_INTEGRATIONS** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.
