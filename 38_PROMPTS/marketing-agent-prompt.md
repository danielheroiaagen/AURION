---
project: AURION
document: Marketing Agent Prompt
folder: 38_PROMPTS
...
## Objetivo
Este documento define instrucciones reutilizables para agentes IA especializados.

## Alcance
Este documento pertenece a **38_PROMPTS** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.
