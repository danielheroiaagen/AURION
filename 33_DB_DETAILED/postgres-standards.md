---
project: AURION
document: Postgres Standards
folder: 33_DB_DETAILED
...
## Objetivo
Este documento profundiza en PostgreSQL, multi-tenant, auditoría, índices, migraciones y calidad de datos.

## Alcance
Este documento pertenece a **33_DB_DETAILED** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.
