---
project: AURION
document: Call Recording Policy
folder: 27_VOICE_IVR
...
## Objetivo
Este documento define la experiencia de voz, llamadas, SIP, IVR inteligente, tool calls y escalado humano.

## Alcance
Este documento pertenece a **27_VOICE_IVR** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.

## Decisiones no negociables
- La conversación debe sentirse natural, rápida y segura.
- El agente debe saber cuándo escalar a humano.
- Las herramientas de voz deben tener timeout, fallback y auditoría.
- No ejecutar acciones sensibles sin confirmación.
