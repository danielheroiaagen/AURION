---
project: AURION
document: Server Components Client Components
folder: 18_FRONTEND
...
## Objetivo
Este documento guía la construcción de interfaces para el panel SaaS, consola de voz, avatar, dashboards y configuración de clientes.

## Alcance
Este documento pertenece a **18_FRONTEND** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.

## Decisiones no negociables
- La UI se diseña por journeys empresariales, no por componentes aislados.
- Toda pantalla debe soportar multi-tenant, permisos y estados de error.
- Los componentes no ejecutan reglas de negocio críticas.
- Las experiencias realtime deben degradar con elegancia.
