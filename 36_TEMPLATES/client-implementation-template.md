---
project: AURION
document: Client Implementation Template
folder: 36_TEMPLATES
...
## Objetivo
Este documento es una plantilla reusable que los agentes deben copiar y completar, no improvisar.

## Alcance
Este documento pertenece a **36_TEMPLATES** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.
