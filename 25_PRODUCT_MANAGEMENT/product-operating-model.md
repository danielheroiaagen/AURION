---
project: AURION
document: Product Operating Model
folder: 25_PRODUCT_MANAGEMENT
...
## Objetivo
Este documento define cómo convertir visión en producto construible, medible y priorizado.

## Alcance
Este documento pertenece a **25_PRODUCT_MANAGEMENT** y forma parte del paquete documental maestro de AURION. Su función es impedir improvisación, alinear a agentes IA y humanos, y mantener una ejecución profesional.
